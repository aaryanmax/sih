...
def extract_frames_from_video(
    ...
    """
    Extracts frames from a video file at specified second intervals using OpenCV.
    ...
    try:
        ...
        raise ImportError(
            "opencv-python is required for extract_frames_from_video. Install with `pip install opencv-python`."
        )
