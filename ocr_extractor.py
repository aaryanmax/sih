...
def text_match_score(query_text: str, ocr_text: str) -> float:
    ...
    fraction of query words that appear in the OCR text. This is the "15%
    OCR overlay text" signal the team's hybrid_search.py fusion is meant to
    combine with visual/audio scores; kept here as a standalone utility so
    it can be computed independent of whoever owns the fusion API.
    """
...
if __name__ == "__main__":
    ...
    print(text_match_score("speed limit 60", "SPEED LIMIT 60 AHEAD"))
    print(text_match_score("red car", "SPEED LIMIT 60 AHEAD"))
    print(text_match_score("ahead", "SPEED LIMIT 60 AHEAD."))  # punctuation check
